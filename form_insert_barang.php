...
<ul>
   ...
   <li class="has-sub"><a href="#">Menu Pelaporan</a>
	...
	<div class="form-group">
      ...
      <div class="col-sm-10">          
        <input name="harga" type="number" class="form-control" id="harga" placeholder="Harga/satuan"><br>
      </div>
    </div>
	  <div class="form-group">
	...
	<div class="form-group">
      ...
      <div class="col-sm-10">          
        <input name="lokasi" type="text" class="form-control" id="lokasi" placeholder="Lokasi Aset"><br>
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" for="jumlah">Jumlah:</label>
      <div class="col-sm-10">          
        <input name="jumlah" type="number" class="form-control" id="jumlah" placeholder="Jumlah"><br>
      </div>
    </div>
    <div class="form-group">   
