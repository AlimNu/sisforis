...
<ul>
   ...
   <li class="has-sub"><a href="#">Menu Pelaporan</a>
      ...
      <h2 class="">Form Data Barang</h2><br>
	  <div class="form-group">
      <label class="control-label col-sm-2" for="jenis">Jenis Aset:</label>
      <div class="col-sm-10">          
        <select name="harga" class="form-control" id="jenis" placeholder="Jenis Aset">
	...
	<div class="form-group">
      ...
      <div class="col-sm-10">          
        <input name="harga" type="number" class="form-control" id="harga" placeholder="Harga/satuan">
      </div>
    </div>
	<div class="form-group">
      <label class="control-label col-sm-2" for="status">Status:</label>
      <div class="col-sm-10">          
        <select name="status" class="form-control" id="status" placeholder="Deskrpisi Aset">
        <option>Bagus</option>
        <option>Kurang Bagus</option>
        <option>Rusak</option>
        </select>
      </div>
    </div>
	<div class="form-group">
      ...
      <div class="col-sm-10">          
        <input name="dsc_aset" type="text" class="form-control" id="dsc_aset" placeholder="Deskrpisi Aset">
      </div>
    </div>
	<div class="form-group">
      <label class="control-label col-sm-2" for="date">Tanggal Masuk Aset:</label>
      <div class="col-sm-10">          
        <input name="tgl_aset" type="date" class="form-control" id="date" placeholder="Tanggal Masuk Aset" >
      </div>
    </div>
	<div class="form-group">
      <label class="control-label col-sm-2" for="id_peg">ID Pegawai:</label>
      <div class="col-sm-10">          
        <input name="id_peg" type="text" class="form-control" id="id_peg" placeholder="ID Pegawai">
      </div>
    </div>
	<div class="form-group">
      <label class="control-label col-sm-2" for="no_aset">No. Aset:</label>
      <div class="col-sm-10">
        <input name="no_aset" type="text" class="form-control" id="no_aset" placeholder="No. Aset Barang">
      </div>
    </div>
	<div class="form-group">
      <label class="control-label col-sm-2" for="lokasi">Lokasi Aset:</label>
      <div class="col-sm-10">          
        <input name="lokasi" type="text" class="form-control" id="lokasi" placeholder="Lokasi Aset">
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" for="jumlah">Jumlah:</label>
      <div class="col-sm-10">          
        <input name="jumlah" type="number" class="form-control" id="jumlah" placeholder="Jumlah">
      </div>
    </div>
    <div class="form-group">   
    ...
    <!--?php
			...
			$quer = "INSERT INTO data_barang(no_aset,id_peg,tgl_aset,dsc_aset,status,harga,jenis,lokasi,jumlah) values 			('$n1','$n2','$n3','$n4','$n5','$n6','$n7','$n8','$n9')";
		mysql_query($quer);
